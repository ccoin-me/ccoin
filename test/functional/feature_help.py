...
"""Verify that starting ccoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ccoin with -h for help text")
        ...
        self.log.info("Start ccoin with -version for version information")
        ...
        self.log.info("Start ccoind with -fakearg to make sure it does not start")

...
ccoin.conf        | contains configuration settings for ccoind or ccoin-qt
ccoind.pid        | stores the process id of ccoind while running
...
debug.log           | contains debug information and general logging generated by ccoind or ccoin-qt

# Support for Output Descriptors in Ccoin Core

Since Ccoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `xcc1...` for mainnet or `txcc1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Ccoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Ccoin Core wallets, a convenience function `combo` is

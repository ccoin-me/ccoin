...
const char* BIP71_MIMETYPE_PAYMENT = "application/ccoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/ccoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/ccoin-paymentrequest";
#endif
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(nullptr, tr("Payment request error"),
                tr("Cannot start ccoin: click-to-pay handler"));
        }
        else {
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("ccoin://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'ccoin://' is not a valid URI. Use 'ccoin:' instead."),
    ...
    else if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
        ...
        // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
            {
                ...
                Q_EMIT message(tr("URI handling"),
                    tr("URI cannot be parsed! This can be caused by an invalid Ccoin address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);

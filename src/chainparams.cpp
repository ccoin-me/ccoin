...
{
    const char* pszTimestamp = "January 9, 2020 — WHO Announces Mysterious Coronavirus-Related Pneumonia in Wuhan, China";
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x8ff9ee83dd27c3a3ae906940959ab15077945184202628617de5924af5ceddd0"); //2
        ...
        genesis = CreateGenesisBlock(1626367559, 4705, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xce482bc5e71a5507930e5710f663e9cda7d6727e9bebd589a3806661093df8b1"));
        assert(genesis.hashMerkleRoot == uint256S("0x70a0fdc84b90b7e9afe8543ad933c894f24b7509fe2ba268477c0e8ea5f30a00"));
        ...
        vSeeds.emplace_back("seed.ccoin.me");
        // vSeeds.emplace_back("seed-a.ccoin.loshan.co.uk");
        // vSeeds.emplace_back("dnsseed.thrasher.io");
        // vSeeds.emplace_back("dnsseed.ccointools.com");
        // vSeeds.emplace_back("dnsseed.ccoinpool.org");
        ...
        checkpointData = {
            {
                {  0, uint256S("0xce482bc5e71a5507930e5710f663e9cda7d6727e9bebd589a3806661093df8b1")},
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1625819538, 764674, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x40f54574bf707f3a4a2c9475ad5dffb53235dba39c927e14db10c2c4a47c0789"));
        assert(genesis.hashMerkleRoot == uint256S("0x70a0fdc84b90b7e9afe8543ad933c894f24b7509fe2ba268477c0e8ea5f30a00"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.ccoin.me");
        // vSeeds.emplace_back("testnet-seed.ccointools.com");
        // vSeeds.emplace_back("seed-b.ccoin.loshan.co.uk");
        ...
        checkpointData = {
            {
                {0, uint256S("0x40f54574bf707f3a4a2c9475ad5dffb53235dba39c927e14db10c2c4a47c0789")},
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1625820067, 310629, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x6b11da297e3be13494cbe44807bb3959a0205c7487b9f6d207b5d5e3cbfc9b74"));
        assert(genesis.hashMerkleRoot == uint256S("0x70a0fdc84b90b7e9afe8543ad933c894f24b7509fe2ba268477c0e8ea5f30a00"));
        ...
        checkpointData = {
            {
                {0, uint256S("0x6b11da297e3be13494cbe44807bb3959a0205c7487b9f6d207b5d5e3cbfc9b74")},
            }
        };

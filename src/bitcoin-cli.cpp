...
static void SetupCliArgs()
{
    ...
    gArgs.AddArg("-rpcwallet=<walletname>", "Send RPC for non-default wallet on RPC server (needs to exactly match corresponding -wallet option passed to ccoind). This changes the RPC endpoint used, e.g. http://127.0.0.1:7332/wallet/<walletname>", false, OptionsCategory::OPTIONS);

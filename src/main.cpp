...
uint256 hashGenesisBlock("0xb6603e7478184f45732059bf7c4f0f6d8421f6c110b4c2198b1904857e35c1c1");
...
static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // Ccoin: 3.5 days
static const int64 nTargetSpacing = 2.5 * 60; // Ccoin: 2.5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x40f54574bf707f3a4a2c9475ad5dffb53235dba39c927e14db10c2c4a47c0789");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1626452879;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 261537;

        if (fTestNet)
        {
            block.nTime    = 1625819538;
            block.nNonce   = 764674;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x70a0fdc84b90b7e9afe8543ad933c894f24b7509fe2ba268477c0e8ea5f30a00"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xec, 0xb1, 0xa7, 0xcc }; // Ccoin: increase each by adding 2 to bitcoin's value.

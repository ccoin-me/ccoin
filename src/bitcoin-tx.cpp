...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " ccoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  ccoin-tx [options] <hex-tx> [commands]  Update hex-encoded ccoin transaction\n" +
            "or:     ccoin-tx [options] -create [commands]   Create hex-encoded ccoin transaction\n" +
            "\n";

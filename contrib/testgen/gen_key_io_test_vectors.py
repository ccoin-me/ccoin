...
bech32_templates = [
  ...
  ('xcc',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('xcc',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('xcc',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('txcc',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('txcc',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('txcc',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rxcc',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rxcc',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rxcc', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('txcc',  17, 32, False, False, False),
  ('rxcc',  3,  1, False, False, False),
  ('xcc',   15, 41, False, False, False),
  ('txcc',  0, 16, False, False, False),
  ('rxcc',  0, 32, True,  False, False),
  ('xcc',   0, 16, True,  False, False),
  ('txcc',  0, 32, False, True,  False),
  ('rxcc',  0, 20, False, False, True)
]
